...
<div class="bg-white rounded-lg shadow-sm p-6">
    <div class="mb-6">
        <h2 class="text-2xl font-semibold text-gray-800">Yeni İçerik Ekle</h2>
        <p class="text-gray-600 mt-1">Yeni bir içerik oluşturun ve SEO ayarlarını yapılandırın.</p>
    </div>

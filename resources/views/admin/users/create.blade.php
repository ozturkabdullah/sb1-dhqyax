...
<div class="bg-white rounded-lg shadow-sm p-6">
    <div class="mb-6">
        <h2 class="text-2xl font-semibold text-gray-800">Yeni Kullanıcı Ekle</h2>
        <p class="text-gray-600 mt-1">Yeni bir kullanıcı hesabı oluşturun ve rollerini atayın.</p>
    </div>
